const HIGHT = document.getElementById('str')
HIGHT.style.cssText = `
...
p.textContent = 'Стоимость проверки документа зависит от размера приобретаемого пакета символов.'
...
button.textContent = 'Одобряю';
button1.textContent = 'Отклоняю';
...
moonImg.src = './image/black-moon.png'
